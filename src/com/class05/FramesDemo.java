...
public class FramesDemo extends CommonMethods {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		 * 1. opening the webpage, the of webdriver will be in the main window by
		 * default 2. some some action in the main window. I'm getting some text from
		 * main window
		 * 
		 * Now I want to do some action inside the frame.
		 * 
		 * 3. now I have to switch to that frame Now here inside the frame I want to do
		 * some other actions
		 * 
		 */
		...
		String insideFText = driver.findElement(By.xpath("//h4[text()='Practice Selenium Automation Testing Online']"))
				.getText();
